...
The requirements for the application were changing as I built it. It was also unlikely that anyone other than me would be the "administrator" of it. Instead of creating a weak administrative interface I choose to create a script describing events and wrote an interpreter to translate that description into the actionable interface. Updating the language and interpreter was far faster than would have been the case with updating an administrative interface. The small event above is described
